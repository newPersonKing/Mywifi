...
public class MakeWifiHotNameActivity extends BaseTitleActivity {
    ...
    protected int onSetContentView() {
        return R.layout.layout_make_wifi_hot_name;
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    @Override
    protected void onInitData() {
        setTitle(R.drawable.retur,"配置WLAN热点账号",0);
        ...
        edtInput=et_wifi_name;

        ll_over.setOnTouchListener(new View.OnTouchListener() {
            @Override
        ...
        keyboardView.setOnKeyboardActionListener(new KeyboardView.OnKeyboardActionListener() {
            ...
            public void onKey(int primaryCode, int[] keyCodes) {
                ...
                Log.i("cccccccccccc","code="+primaryCode);
                switch (primaryCode) {
...
//                        keyboardView.setKeyboard(numberKB);
    ...
    private void appendContent(int index){
        ...
        if (editable != null) {
            if (content.equals("...")){
                editable.insert(start,content.substring(index,index+3));
            }else {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.btn_sure:
                ...
                intent.putExtra("name",et_wifi_name.getText().toString());
